...
if [[ ! -f "docker-compose.yml" ]]; then
    ...
    curl -o "docker-compose.yml" "https://raw.githubusercontent.com/rbrecheisen/MosamaticWeb3.0/refs/heads/main/versions/arm64/3.0.0/cpu/docker-compose-prod.yml"
fi
