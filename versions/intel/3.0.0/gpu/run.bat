...
if not exist "docker-compose.yml" (
    ...
    powershell -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/rbrecheisen/MosamaticWeb3.0/refs/heads/main/versions/intel/3.0.0/gpu/docker-compose.yml' -OutFile 'docker-compose.yml'"
)
